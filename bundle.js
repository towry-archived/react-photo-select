...
/***/ function(module, exports, __webpack_require__) {
	...
	var PhotoSelect = __webpack_require__(159);

	var _Styles = __webpack_require__(162);
	var _AppStyles = __webpack_require__(166);
	...
	var App = React.createClass({
	  ...
	  _onclose: function _onclose(item) {
	    this.setState({
	      close: !this.state.close
	    });
	  },
	  ...
	  render: function render() {
	    ...
	    if (this.state.selected) {
	      ...
	      selectedOne = React.createElement('img', { style: style, src: this.state.selected.url, title: '', alt: '' });
	    }
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(PhotoSelect, { onCancel: this._oncancel, onClose: this._onclose, onSelect: this._onselect, photos: this.state.photos, initialClose: this.state.close })
	      ),
	      React.createElement(
	        'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Select = React.createClass({
	  ...
	  _onselect: function _onselect(payload) {
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'div',
	          { className: 'select-photos' },
	          this.props.photos.map((function (photo, i) {
	            return React.createElement(Photo, { onclick: this._onselect, key: 'photo-' + i, url: photo.url, title: photo.title, alt: photo.alt });
	          }).bind(this))
	        ),
	        React.createElement(
	          'div',
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'button',
	              { onClick: this._onclose, className: 'select-action_confirm' },
	              confirmText
	            ),
	            React.createElement(
	              'button',
	              { onClick: this._oncancel, className: 'select-action_cancel' },
	              cancelText
	            )
	          )
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Photo = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      { className: "photo-item" + cls },
	      React.createElement(
	        'div',
	        { onClick: this._onClick, className: 'photo-item_container' },
	        React.createElement('img', { className: 'photo-item_image', src: this.props.url,
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./react-select-photo.css", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./react-select-photo.css");
